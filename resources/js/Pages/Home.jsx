...
import poster from "../../../public/images/home/poster.jpg";
        ...
        <div className="container mx-auto">
          ...
          <div className="-mx-4 flex flex-wrap mt-14">
            ...
            <div className="w-full px-10 md:w-1/2 lg:w-1/5">
              <div className="wow fadeInUp group mb-10" data-wow-delay=".1s">
                ...
                <div className="flex-wrap mt-1">
                  <a
                    href="javascript:void(0)"
                    className="mb-3 bg-primary/[0.08] inline-block rounded-[5px] px-4 py-0.5 text-center text-xsfont-medium leading-loose text-dark hover:bg-primary hover:text-white"
                  >
                    [Genre]
                  </a>
                  <a
            ...
            <div className="w-full px-10 md:w-1/2 lg:w-1/5">
              <div className="wow fadeInUp group mb-10" data-wow-delay=".1s">
                <div className="mb-8 overflow-hidden rounded-[5px]">
                  <a href="detail-page" className="block">
                    <img
                      src={poster}
                      alt="image"
                      className="w-full transition group-hover:rotate-6 group-hover:scale-125"
