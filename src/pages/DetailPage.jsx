import poster2 from "../assets/images/blog/poster-2.jpg";
import author1 from "../assets/images/blog/article-author-01.png";
import author2 from "../assets/images/blog/article-author-02.png";
import author3 from "../assets/images/blog/article-author-03.png";
import author4 from "../assets/images/blog/article-author-04.png";
import testimonial1 from "../assets/images/testimonials/author-01.jpg";
import testimonial2 from "../assets/images/testimonials/author-02.jpg";
import testimonial3 from "../assets/images/testimonials/author-03.jpg";
import starIcon from "../assets/images/testimonials/icon-star.svg";
          ...
          <div className="flex flex-wrap">
            <div className="w-full p-4 md:w-1/2 lg:w-3/12 flex items-center border-b border-stroke">
              <div className="mr-5 h-20 w-20 rounded-full">
                <img src={author1} alt="Actor Image" className="w-full" />
              </div>
              <div>
            ...
            <div className="w-full p-4 lg:w-3/12 md:w-1/2 flex items-center border-b border-stroke">
              <div className="mr-5 h-20 w-20 max-w-[80px] overflow-hidden rounded-full">
                <img src={author2} alt="Actor Image" className="w-full" />
              </div>
              <div>
                <h4 className="text-lg font-medium leading-snug text-dark">
                  Name
            ...
            <div className="w-full p-4 lg:w-3/12 md:w-1/2 flex items-center border-b border-stroke">
              <div className="mr-5 h-20 w-20 max-w-[80px] overflow-hidden rounded-full">
                <img src={author3} alt="Actor Image" className="w-full" />
              </div>
              <div>
                <h4 className="text-lg font-medium leading-snug text-dark">
                  Name
            ...
            <div className="w-full p-4 lg:w-3/12 md:w-1/2 flex items-center border-b border-stroke">
              <div className="mr-5 h-20 w-20 max-w-[80px] overflow-hidden rounded-full">
                <img src={author4} alt="Actor Image" className="w-full" />
              </div>
              <div>
                <h4 className="text-lg font-medium leading-snug text-dark">
                  Name
