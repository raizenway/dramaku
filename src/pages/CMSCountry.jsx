...
const CMSCountry = () => {
  return (
    <>
      <div className="bg-dark flex justify-center mx-4 lg:hidden md:hidden">
        <div className="w-60 max-w-full p-4">
      ...
      <div className="flex justify-center">
        <div className="bg-dark text-white space-y-6 py-7 px-1 w-70 hidden md:block">
          ...
          <nav>
            ...
            <a
              href="/cms-genres.html"
              className="mx-8 flex py-2 text-base font-medium hover:text-primary"
            >
              Genres
            </a>
            <a
              href="/cms-actors.html"
              className="mx-8 flex py-2 text-base font-medium hover:text-primary"
            >
              Actors
            </a>
            <a
              href="/cms-comments.html"
              className="mx-8 flex py-2 text-base font-medium hover:text-primary"
            >
              Comments
            </a>
